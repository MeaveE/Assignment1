...
I started the assinmetnt the day we got it so the code is far messier than had I started later
...
so with out getting arguements from the code and I have just gotten to the stage where I am terrified
...
a 1000 by 1000 sized screen hoping to make it large enough to satisfy.
